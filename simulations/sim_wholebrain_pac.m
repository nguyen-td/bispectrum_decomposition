...
function signal_roi = sim_wholebrain_pac
    ...
    params.case = 3; % univariate + bivariate case
    params.iInt = [1 2]; % one univariate, two bivariate interactions
    params.iReg = 1; 
    ...
    [sig, brain_noise, sensor_noise, L, iroi_phase, iroi_amplt, D, fres, n_trials, filt] = fp_pac_signal(params, D);
