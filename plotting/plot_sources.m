...
function plot_sources(F_moca, F, n, cortex75k, cortex2k, source_inds, cm, isub, DIROUT, varargin)
    ...
    for i = 1:n
        ...
        allplots_cortex_nyhead_v2(cortex75k, source_moca(cortex2k.in_to_cortex75K_geod), [min(source_moca, [], 'all') max(source_moca, [], 'all')], cm, 'demixed sources', 1, f_name_moca, ...
        ...
        allplots_cortex_nyhead_v2(cortex75k, source_mixed(cortex2k.in_to_cortex75K_geod), [min(source_mixed, [], 'all') max(source_mixed, [], 'all')], cm, 'mixed sources', 1, f_name_mixed, ...
            {cortex75k.vc_smooth(cortex2k.in_from_cortex75K(source_inds), :)})
    end
